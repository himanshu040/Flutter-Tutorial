...
class AesHelper {
  ...
  static String encrypt(String password, String plaintext,
    ...
    //print("dericedkey: $derivedKey");

    String printkey = new String.fromCharCodes(derivedKey);
    ...
    final enckey = Key.fromUtf8(printkey);
    final encrypter =
        Encrypter(AES(enckey, mode: AESMode.cbc, padding: 'PKCS7'));
    final ivs = IV.fromLength(16);

    // final encrypter = Encrypter(AES(enckey));
    final encrypted = encrypter.encrypt(plaintext, iv: ivs);
    //print("enc: $encrypted");
